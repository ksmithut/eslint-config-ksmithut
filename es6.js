...
module.exports = {
  ...
  rules: {
    ...
    'no-restricted-imports': 0, // restrict usage of specified modules when loaded by import declaration - http://eslint.org/docs/rules/no-restricted-imports
    ...
    'prefer-reflect': 1, // suggest using Reflect methods where applicable - http://eslint.org/docs/rules/prefer-reflect
    'prefer-rest-params': 2, // suggest using the rest parameters instead of arguments - http://eslint.org/docs/rules/prefer-rest-params
    'prefer-spread': 2, // suggest using the spread operator instead of .apply() - http://eslint.org/docs/rules/prefer-spread
